        ...
        <section className="w-full bg-black py-16 px-4">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center mb-12">
                    ...
                    <h2 className="text-white text-4xl md:text-5xl font-bold uppercase tracking-wider" style={{ fontFamily: 'stencil, sans-serif' }}>
                        SOCIAL PAGES
                    </h2>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {pages.map((page, index) => (
                        <div key={index} className="bg-black border border-gray-700 rounded-xl p-8 flex flex-col items-center text-center h-full hover:border-accent transition-colors duration-300">
                            <h3 className="text-accent text-xl md:text-2xl font-bold mb-6 tracking-wide" style={{ fontFamily: 'stencil, sans-serif' }}>
                                {page.title}
                            </h3>
                            <p className="text-white text-sm leading-relaxed mb-8 flex-grow max-w-xs">
                                {page.description}
                            </p>
                            <button className="bg-[#2a2a2a] text-white text-xs font-bold py-3 px-8 rounded-full uppercase tracking-wider hover:bg-accent transition-colors">
                                {page.buttonText}
                            </button>
                        </div>
                    ))}
