    ...
    return (
        <section className="w-full bg-black">
            <div className="w-full flex flex-col lg:flex-row h-96">
                {/* Left Placeholder */}
                <div className="w-full lg:w-1/2 bg-gray-800 flex items-center justify-center border-r border-gray-700">
                ...
                {/* Right Placeholder */}
                <div className="w-full lg:w-1/2 bg-gray-800 flex items-center justify-center">
                    <span className="text-white text-2xl font-bold uppercase tracking-widest">
                        this is right
                    </span>
                </div>
