    ...
    <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-12 mb-16">
            ...
            <div className="flex flex-col gap-8">
                {/* Logo */}
                <img src="/images/social-logo.png" alt="SOCIAL" className="h-12 md:h-16" />
...
const Footer = () => {
    return (
        <>
            {/* Spacer - Invisible copy to take up space in the document flow */}
            <div className="w-full bg-black pt-16 pb-8 px-4 border-t border-gray-900 opacity-0 pointer-events-none">
                <FooterContent />
            </div>

            {/* Fixed Footer - Visible and interactive, fixed at the bottom */}
            <div className="fixed bottom-0 left-0 w-full bg-black pt-16 pb-8 px-4 border-t border-gray-900 z-0">
                <FooterContent />
            </div>
        </>
    );
